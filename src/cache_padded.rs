...
///
/// # Copyright
/// This implementation is a direct copy of the implementation in [crossbeam-utils](https://crates.io/crates/crossbeam-utils).
/// It is licensed under MIT OR Apache-2.0.
